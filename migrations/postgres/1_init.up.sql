...
(email, hash_password, fio, date_of_birth, gender, phone_number, parent_phone_number, current_school, education_year, activation_token, change_password_token)
VALUES ('admin@admin.admin', '$2a$10$R/BGDayqUh9FZODPYwYKburFqRaIyomR/XWD33eVX9KmHPGAYeH3.', 'admin', now(), 'male', 'none', 'none', 'none', 0, uuid_generate_v4(), uuid_generate_v4());
...
VALUES (1, 'Психология', 10),
       ...
       (6, 'Дизайн', 10),
       (7, 'Востоковедение', 10),
       (8, 'Информатика, инижинерия и математика', 10),
