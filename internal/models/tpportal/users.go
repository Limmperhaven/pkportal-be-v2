...
var (
	userAllColumns            = []string{"id", "email", "hash_password", "fio", "date_of_birth", "gender", "phone_number", "parent_phone_number", "current_school", "education_year", "role"}
	userColumnsWithoutDefault = []string{"email", "hash_password", "fio", "date_of_birth", "gender", "phone_number", "parent_phone_number", "education_year"}
	userColumnsWithDefault    = []string{"id", "current_school", "role"}
